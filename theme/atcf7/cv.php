...
<div class="form-basic">
  ...
  <div class="btn-transparent group relative text-center max-w-full w-fit mx-auto [&_.wpcf7-spinner]:absolute [&_.wpcf7-spinner]:right-[-7px] [&_.wpcf7-spinner]:top-4 [&_svg_path]:hover:fill-secondary [&_svg_circle]:hover:stroke-secondary">
    ...
    <svg class="absolute right-5 top-[18px] pointer-events-none" width="14" height="10" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path class="stroke-white group-hover:stroke-primary transition duration-200" d="M0.774525 0.500055L5.50054 5.75635L10.2266 0.500055" stroke="#FFFFFF" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  </div>
</div>