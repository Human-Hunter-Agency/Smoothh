...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url(wc_get_checkout_url()) . is_user_logged_in() ? '?is_guest=true' : ''; ?>" enctype="multipart/form-data">
