    ...
    <div class="shop_table_responsive cart woocommerce-cart-form__contents w-full">
        <div class="hidden md:flex gap-2.5 lg:gap-5 items-end">
            ...
            <?php if(WC()->cart->has_discount()) : ?>
                <span class="product-discount shrink-0 grow-0 w-[15%] text-right text-base lg:text-xl font-semibold p-5 lg:p-7 lg:pb-8 min-w-32 lg:min-w-40 rounded-t-[15px] bg-primary text-white"><?php esc_html_e('Discount', 'woocommerce'); ?>:</span>
            <?php endif; ?>
        </div>
        ...
        <ul class="text-xl">
            ...
            ?>
                    <li class="woocommerce-cart-form__cart-item cart_item flex flex-col md:flex-row gap-2.5 lg:gap-5 mb-5 md:mb-0 <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                        ...
                        <?php if(WC()->cart->has_discount()) : ?>
                            <div class="flex shrink-0 justify-between md:justify-end items-center md:items-start grow-0 md:w-[15%] md:p-5 lg:pb-8 lg:px-7 md:!pt-0 text-right md:bg-primary min-w-32 lg:min-w-40">
            ...
            <div class="flex flex-col gap-2.5 md:gap-0 md:flex-row justify-end text-xl mb-5">
                ...
                <?php if(WC()->cart->has_discount()) : ?>
                    <div class="flex flex-row justify-between md:justify-end items-center grow-0 shrink-0 md:w-[15%] md:px-5 lg:px-7 md:bg-primary rounded-b-[15px] min-w-32 lg:min-w-40 ">
