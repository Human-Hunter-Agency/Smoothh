        ...
        <ul class="text-xl">
            ...
            <div class="flex flex-col gap-2.5 md:gap-0 md:flex-row justify-end text-xl mb-5">
                ...
                <div class="flex items-center md:items-start justify-between md:w-[calc(30%_+_20px)] lg:w-[calc(30%_+_40px)]">
                    <span class="md:w-[calc(50%_+_10px)] lg:w-[calc(50%_+_20px)] md:min-w-28 text-right md:pt-2.5 text-primary font-semibold md:border-t border-[#F2F2F2]"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?>:</span>
