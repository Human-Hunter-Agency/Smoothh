...
?>
	<div id="product-<?php the_ID(); ?>" <?php wc_product_class('', $product); ?>>
		...
		<section>
			...
			?>
				<div class="container mx-auto w-full translate-y-1/2 px-4 md:px-8 lg:px-24 py-8 md:py-14 flex flex-col md:flex-row gap-2 items-center justify-between drop-shadow-2xl rounded-3xl bg-gradient-to-b from-secondary to-primary">
