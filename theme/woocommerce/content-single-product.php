...
?>
	<div id="product-<?php the_ID(); ?>" <?php wc_product_class('', $product); ?>>
		<div class="relative w-full min-h-[300px] md:min-h-[400px] flex flex-col items-center justify-center mb-[50px] md:mb-[100px]">
		...
		<div class="container mb-20 flex flex-col lg:flex-row lg:justify-between gap-5 md:gap-6 lg:gap-10">
			<div class="w-full">
				<div id="description" class="prose-smoothh prose prose-base md:prose-h2:text-xl mb-9 md:mb-[55px] md:prose-h2:text-primary">
					<?php 
