...
<div class="quantity !mr-3 items-center">
    ...
    <div data-js="qty-control" class="flex items-center gap-1">
        ...
        <button data-js="down" type="button" class="group appearance-none p-1 shrink-0 cursor-pointer">
            <svg class="size-4 stroke-primary group-hover:stroke-foreground transition duration-200" width="16" height="15" viewBox="0 0 12 1" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        type="<?php echo esc_attr( $type ); ?>"
            ...
            class="<?php echo esc_attr( join( ' ', (array) $classes ) ); ?> text-xl shrink-0 font-semibold appearance-none !size-10 bg-transparent border border-primary rounded-md overflow-hidden text-primary"
