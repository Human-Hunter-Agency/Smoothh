...
<h3 class="mb-5 text-2xl font-semibold"><?php esc_html_e('Account details', 'smoothh'); ?></h3>

<form class="woocommerce-EditAccountForm edit-account smoothh-inputs-validation" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo esc_attr($user->display_name); ?>" /> <span class="text-base text-gray-500"><em><?php esc_html_e('This will be how your name will be displayed in the account section and in reviews', 'woocommerce'); ?></em></span>
	</p>
	...
	<fieldset class="w-full">
		<legend>
			<h3 class="mt-5 mb-2 text-2xl font-semibold"><?php esc_html_e('Password change', 'woocommerce'); ?></h3>
		</legend>
