  ...
  <div class="py-20 flex flex-col md:flex-row gap-5" id="customer_login">
    ...
    ?>
      <div class="px-8 pt-9 pb-6 border border-[#888] rounded-[15px]">
        ...
        <a href="<?php echo get_permalink( wc_get_page_id( 'checkout' ) ); ?>" class="h-[55px] w-full !mb-3 flex items-center gap-4 !text-white !font-semibold rounded-2xl bg-gradient-to-b from-primary to-secondary py-2 px-5 xl:px-[50px] 2xl:px-8">
