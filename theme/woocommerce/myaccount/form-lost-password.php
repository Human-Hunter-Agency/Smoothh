...
<div class="relative w-full py-10 pb-5 md:pt-[70px] mt-10 mb-20">
  <div class="z-[-1] w-[100%] h-[80%] absolute top-0 left-0 bg-gradient-to-r from-[rgba(129,23,238,0)] to-[rgba(129,23,238,0.102)]"></div>

  <form method="post" class="woocommerce-ResetPassword lost_reset_password !px-5 md:!px-8 !pt-9 !pb-6 !my-0 border !border-primary shadow-2xl bg-white !rounded-[15px]">
