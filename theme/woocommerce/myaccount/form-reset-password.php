...
<form method="post" class="woocommerce-ResetPassword lost_reset_password test py-20">

	<p><?php echo apply_filters('woocommerce_reset_password_message', esc_html__('Enter a new password below.', 'woocommerce')); ?></p><?php  ?>
