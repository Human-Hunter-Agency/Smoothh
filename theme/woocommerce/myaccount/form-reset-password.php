...
<div class="relative w-full py-10 pb-5 md:pt-[70px] mt-10 mb-20">
	...
	<form method="post" class="woocommerce-ResetPassword lost_reset_password mx-auto max-w-[800px] !px-5 md:!px-8 !pt-9 !pb-6 !my-0 !border-primary border-[1px] shadow-2xl bg-white !rounded-[15px]">
		...
		<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first p-0 mb-5">
		...
		<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last p-0 mb-5">
