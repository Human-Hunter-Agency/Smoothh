...
?>
    <div class="<?php echo esc_attr(apply_filters('woocommerce_product_price_class', 'price')); ?> flex flex-col gap-1">
        <p class=" flex items-end shrink-0 [&_.woocommerce-Price-currencySymbol]:hidden text-primary [&_bdi]:text-4xl [&_del_bdi]:!text-xl [&_bdi]:!font-normal [&_bdi]:text-primary [&_ins]:no-underline [&_del_bdi]:!text-foreground [&_del]:h-8 [&_del]:!decoration-foreground [&_del_bdi]:mr-1.5">
            ...
            <?php endif ?>
            <span class="flex flex-col items-end"><?php echo $product->get_price_html(); ?> </span>
