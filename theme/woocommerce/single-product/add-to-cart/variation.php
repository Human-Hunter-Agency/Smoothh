...
<script type="text/template" id="tmpl-variation-template">
    ...
    <span class="woocommerce-variation-tax pb-5 border-[#D6D6D6] border-b-[1px] text-[#A7A7A7] text-lg md:text-base text-right ml-auto block">{{{ data.variation.tax_text }}}</span>
