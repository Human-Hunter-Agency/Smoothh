...
global $product;
?>
<div class="woocommerce-variation-add-to-cart variations_button flex <?php if($product->is_type('variable')){echo ' [&_.quantity]:!mr-3 items-end';}else{ echo '[&_.quantity]:!hidden';} ?>">
