		...
		<p class="form-row terms wc-terms-and-conditions">
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox flex items-start justify-center gap-x-2 [&_a]:text-primary">
				...
				<span>
					...
					<a href="<?php echo get_term_link(); ?>" target="_blank" class="woocommerce-terms-and-conditions-link inline"><?php esc_html_e('terms & conditions', 'smoothh'); ?></a>
					<?php printf(__('<a href="%s" target="_blank" class="woocommerce-terms-and-conditions-link">terms & conditions</a>', 'woocommerce'), esc_url(wc_get_page_permalink('terms'))); ?></span> <span class="required">*</span>
			</label>
