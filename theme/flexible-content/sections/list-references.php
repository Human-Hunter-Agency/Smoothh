    ...
    <div class="container mb-10 md:mb-20">
        <div class="flex flex-col gap-5 md:gap-10 lg:gap-[72px]">
            <?php foreach($list as $item) : ?>
                <div class="flex flex-col md:flex-row border-2 border-[#B8B8B8]">
                <?php if( $item['logo'] ): ?> 
                    ...
                    <div class="shrink-0 flex items-center justify-center border-0 border-b-2 md:border-b-0 md:border-r-2 border-[#B8B8B8] md:w-[200px] lg:w-[250px] xl:w-[400px] p-5 lg:p-10 xl:px-[70px]">
                        <img class="object-contain w-full max-h-20 md:max-h-44" src="<?php echo $item['logo']['url']; ?>" alt="<?php echo $logo['alt']; ?>" alt="<?php echo $logo['title']; ?>" />
                    </div>
                ...
                <?php endif; ?>
                    <div class="flex flex-col justify-between min-h-64 p-5 md:px-10">
                        <div>
                            ...
                            <?php if( $item['review'] ): ?> 
                                <p class="text-base md:text-xl italic mb-5"><?php echo esc_attr( $item['review'] ); ?></p>
                            <?php endif; ?>
                        </div>
