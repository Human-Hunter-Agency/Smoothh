...
<div class="w-full py-10 md:py-[70px] mb:pb-20 mt-10 md:mt-20">
    ...
    <div class="relative z-0 container">
        <?php if ($header) : ?>
            <div class="mb-6 prose-smoothh prose md:prose-xl h2:text-2xl md:h2:text-5xl lg:h2:text-[46px] lg:h2:font-extrabold lg:h2:leading-[55px] p:text-[16px] prose-p:leading-[26px] prose-img:mt-0 prose-img:mx-auto prose-img:px-5">
                <?php echo $header; ?>
            </div>
        <?php endif; ?>
        <?php if ($description) : ?>
