...
<div class="relative py-10 md:py-20 <?php if (!$isDecorationOverflow) : ?> overflow-hidden <?php endif; ?>">
    <div class="z-[-1] lg:w-[85%] 2xl:w-[88%] lg:h-[1200px] absolute top-0 right-0 rounded-[45px] <?php if (!$isDecorationOverflow) : ?> !rounded-none <?php endif; ?> bg-gradient-to-l to-[rgba(129,23,238,0)] from-[rgba(129,23,238,0.102)]"></div>
