                        ...
                        <div class="swiper-slide !h-auto _xl:flex-1 xl:!basis-1/4 px-3 md:px-5 !mr-0 pr-4 xl-pr-auto last:!px-0">
                            <div class="flex flex-col items-center text-center ">
                                ...
                                ?>
                                    ...
                                    <div class="w-1/2 h-[2px] border-t-[2px] border-solid border-t-primary absolute top-[67px] left-[-36px] z-[-1] <?php if (($i+1 == $listLength && ($i+1)%2 != 0)): ?>desktop:hide<?php endif; ?>"></div>
