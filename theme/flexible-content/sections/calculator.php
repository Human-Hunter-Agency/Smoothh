...
<div id="calculator" class="relative py-10 md:py-[70px]">
    <div data-calc-bg class="!hidden z-[-1] w-[100%] lg:w-[97%] h-full absolute top-0 left-0 bg-gradient-to-r to-[rgba(31,151,212,0.1)] from-[rgba(31,151,212,0)] rounded-[45px]"></div>
    <div class="container calculator">
        <?php if ($header) : ?>
            <div class="mb-10 md:mb-[50px]">
                <h2 class="text-center text-2xl md:text-4xl lg:text-[46px] font-bold lg:font-extrabold lg:leading-[55px] text-foreground prose-strong:text-primary">
                    <?php echo __($header); ?>
                </h2>
            </div>
        <?php endif; ?>
