...
<div class="relative py-10 md:py-20 <?php if ($has_bg) : ?> md:pt-[60px] bg-gradient-to-b from-secondary to-primary text-white <?php endif; ?>">
    <div class="container">
        <div class="relative z-0">
            ...
            <?php endif; ?>
            <?php if ($content) : ?>
                <div class="prose-smoothh prose md:prose-xl prose-h3:text-2xl md:prose-h3:text-5xl lg:prose-h3:text-5xl prose-img:mt-0 prose-img:mx-auto prose-img:px-5 md:prose-p:leading-7 <?php if ($has_bg) : ?> [&_*]:!text-white <?php endif; ?> [&>p>img]:inline [&>p>img]:w-[70px] [&>p>img]:h-[70px] [&>p>img]:!m-0 [&>p>img]:!p-0">
                    <?php echo $content; ?>
                </div>
            <?php endif; ?>
        </div>
