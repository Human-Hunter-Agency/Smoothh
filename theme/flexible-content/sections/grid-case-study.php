...
<div id="<?php if ($section_ID) : echo $section_ID;
	...
	<div class="relative z-0 w-full overflow-hidden !pb-20">
		<?php if ($posts) : ?>
			<div class="swiper !container !overflow-visible" data-js="swiper-tiles-default">
				<div data-js-case-studies-grid='container' class="swiper-wrapper xl:!transform-none xl:!flex-wrap xl:gap-12">
	...
	<button data-js-case-studies-grid="load-more" class=" flex mx-auto xl:mt-14 gap-4 items-center text-[20px] font-bold py-[15px] px-5 md:px-8  hover:text-primary disabled:!opacity-20 transition-all duration-200 disabled:pointer-events-none ">
