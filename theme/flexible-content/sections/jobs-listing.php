    ...
    <div class="container">
        ...
        ?>
            <div data-js-jobs="container" data-js-endpoint="<?php echo $endpoint_url; ?>">
                ...
                <form data-js-jobs="searchbar" class="!hidden px-10 py-12 bg-[#F2F2F2] mx-auto max-w-screen-lg rounded-t-2xl flex">
                    ...
                    <button class="!ml-[-15px] shrink-0 !relative z-10 h-auto !text-base !text-white !font-bold !text-center !rounded-t-r-2xl !rounded-b-r-2xl hover:!bg-gradient-to-b !bg-gradient-to-b from-primary via-secondary to-secondary bg-size-200 bg-pos-0 hover:bg-pos-100 focus:bg-pos-100  disabled:!bg-[#C9C9C9] [&.disabled]:!bg-[#C9C9C9] disabled:!bg-none [&.disabled]:!bg-none disabled:!opacity-100 [&.disabled]:!opacity-100 transition-all duration-200 !p-2 !px-5 xl:!px-[50px]"><?php echo __('Search', 'smoothh') ?></button>
                </form>
                <ul data-js-jobs="filters" class="mx-auto max-w-screen-lg p-10 bg-[#F2F2F2] !hidden flex justify-center flex-wrap gap-x-5 gap-y-2.5 mb-10 md:mb-14 rounded-b-2xl">
                </ul>
