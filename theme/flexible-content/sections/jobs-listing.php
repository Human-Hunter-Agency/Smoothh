    ...
    <div class="container">
        ...
        ?>
            <div data-js-jobs="container" data-js-endpoint="<?php echo $endpoint_url; ?>">
                ...
                <form data-js-jobs="searchbar" class="!hidden px-10 py-12 bg-[#F2F2F2] mx-auto max-w-screen-lg rounded-t-2xl mb-6 flex">
                ...
                <ul data-js-jobs="filters" class="mx-auto max-w-screen-lg px-10 bg-[#F2F2F2] !hidden flex justify-center flex-wrap gap-x-5 gap-y-2.5 mb-10 md:mb-14 rounded-b-2xl">
                </ul>
