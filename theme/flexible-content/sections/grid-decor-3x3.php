...
<div class="relative py-10 md:py-20 mt-20">
    <div class="z-[-1] lg:w-[85%] 2xl:w-[88%] lg:h-[calc(100%_-_50px)] absolute top-0 right-0 bg-gradient-to-l to-[rgba(129,23,238,0)] from-[rgba(129,23,238,0.102)]"></div>
    <div class="container">
        <div class=" mb-20 flex flex-col lg:flex-row gap-10 lg:gap-24">
