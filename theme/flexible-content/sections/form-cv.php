...
<div class="w-full py-10 md:py-[70px] mb:pb-20 text-white bg-gradient-to-b from-secondary to-primary">
    <div class="container">
        <?php if ($header) : ?>
            <h2 class="text-3xl md:text-5xl font-semibold mb-9 text-center"><?php echo esc_html($header); ?></h1>
            <?php endif; ?>
            <?php if ($description) : ?>
                <div class="mx-auto maxw-[900px] prose-smoothh prose md:prose-xl text-white text-center mb-10 prose-h2:!text-white prose-h2:font-bold prose-h2:text-3xl prose-h2:md:text-5xl prose-h2:mb-9"><?php echo $description; ?></div>
            <?php endif; ?>
