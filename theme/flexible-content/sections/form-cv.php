...
<div class="w-full py-10 md:py-[70px] mb:pb-20 text-white bg-gradient-to-b from-secondary to-primary">
    <div class="container">
        <?php if ($header) : ?>
            <h2 class="text-3xl md:text-5xl font-bold mb-9 text-center" ><?php echo esc_html($header); ?></h1>
        <?php endif; ?>        
        <?php if ($description) : ?>
        ...
        <?php endif; ?>
        <div class="!max-w-[1410px] mx-auto <?php if ($hide_message_field) {echo '[&_.message-container]:hidden';} ?>">
