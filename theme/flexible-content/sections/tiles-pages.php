...
<div class="relative py-10 md:py-[60px] mb:pb-[60px]">
    <div class="z-[-1] xl:w-[85%] 2xl:w-[88%] lg:h-[1024px] absolute top-8 right-0 bg-gradient-to-r from-[rgba(31,151,212,0.1)] to-[rgba(31,151,212,0)]"></div>
    <?php if ($decoration) : ?>
    ...
    <div class="relative z-0 w-full overflow-hidden !pb-32">
        <?php if ($tiles_list) : ?>
            <div class="swiper !container !overflow-visible" data-js="swiper-tiles-default">
                ...
                <div class="swiper-nav w-32  h-20 flex gap-5 !absolute !top-auto !bottom-[-100px] left-[50%] -translate-x-1/2">
