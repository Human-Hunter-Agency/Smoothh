...
<div class="container mx-auto relative">
    <div class="h-[165px] mx-auto w-full translate-y-20 px-4 md:px-8 lg:px-24 py-8 md:py-14 flex flex-row gap-2 md:gap- items-center justify-between drop-shadow-2xl rounded-3xl bg-gradient-to-b from-secondary to-primary">
        <?php if ($header) : ?>
