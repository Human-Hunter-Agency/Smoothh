        ...
        ?>
            <?php if ($question && $answer) : ?>
                <div class="border-2 border-primary rounded-2xl mb-2.5" data-js="dropdown">
                    <div class="group flex justify-between py-5 px-6 cursor-pointer" aria-expanded="<?php if (++$i === $numItems) {
                                                                                                        echo 'true';
                                                                                                    } else {
                                                                                                        echo 'false';
    ...
    <script type="application/ld+json">
        {
            ...
            ?>
                {
                    "@type": "Question",
                    "name": "<?php echo esc_html($question); ?>",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "<?php echo esc_html($answer); ?>"
                    }
                }, 
