        ...
        ?>
            <div class="py-10 lg:py-20 px-8 lg:px-36 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:gap-x-[110px] lg:gap-y-[90px] xl:gap-10 2xl:gap-[140px] bg-white rounded-[45px] drop-shadow-2xl">
                <?php foreach ($tiles_list as $tile) :
                    $tileID++;
                ?>
                    <div class="relative flex flex-col items-center text-left <?php if ($tileID == 1 || $tileID == 2) : ?> lg:before:content-[''] lg:before:w-1/2 before:bg-secondary lg:before:h-[2px] before:absolute xl:before:bottom-[-20px] 2xl:before:bottom-[-70px] before:left-0 <?php endif; ?>">
