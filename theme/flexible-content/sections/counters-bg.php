...
<div class="relative w-full py-10 pb-5 md:pt-[70px] mt-10 mb-20">
    ...
    <div class="pt-14 relative z-0 container">
        ...
        <?php if ($tiles_list) :
            $tileID = 0;
        ?>
            <div class="py-10 lg:py-20 px-8 lg:px-36 grid grid-cols-1 gap-x-10 gap-y-10 sm:grid-cols-2 lg:gap-x-[110px] lg:gap-y-[90px] bg-white rounded-[45px] drop-shadow-2xl">
                <?php foreach ($tiles_list as $tile) :
                    $tileID++;
                ?>
                    <div class="relative flex flex-col items-center text-left <?php if ($tileID == 1 || $tileID == 2) : ?> xl:before:content-[''] xl:before:w-1/2 before:bg-secondary xl:before:h-[2px] before:absolute lg:before:bottom-[-45px] before:left-0 <?php endif; ?>">
