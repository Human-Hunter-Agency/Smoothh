...
<div class="relative w-full py-10 pb-5 md:pt-[70px] mt-10 md:my-20">
        ...
        <?php if ($tiles_list) : ?>
            <div class="py-10 lg:py-20 px-8 lg:px-36 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:gap-x-[110px] lg:gap-y-[90px] xl:gap-10 2xl:gap-[140px] bg-white rounded-[45px] drop-shadow-2xl">
                <?php foreach ($tiles_list as $tile) : ?>
                    <div class="flex flex-col items-center text-left before:content-[''] before:w-1/2 before:bg-[#1F97D4] before:h-[2px] before:absolute before:bottom-[-40px] before:left-0">
