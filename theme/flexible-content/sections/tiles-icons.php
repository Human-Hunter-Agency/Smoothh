...
<div id="<?php if ($section_ID) : echo $section_ID;
    ...
    <div class="container">
        <div class="relative z-0">
            <?php if ($header) : ?>
                <div class="mx-auto max-w-[940px] mb-10 lg:mb-7 text-2xl md:text-4xl lg:text-[46px] font-bold lg:font-extrabold lg:leading-[55px]">
                    <?php echo $header; ?>
                </div>
            <?php endif; ?>
            <?php if ($description) : ?>
    ...
    <div class="relative z-0 w-full overflow-hidden pb-10 md:pb-10 mb:pb-[60px]">
	<?php if ($blueBg) : ?>
